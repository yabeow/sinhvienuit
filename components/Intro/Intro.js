    ...
    return (
      ...
      >
        <View style={[styles.slide, { backgroundColor: '#43A047' }]}>
          ...
          <View level={15}>
            <Text style={styles.text}>Ứng dụng cho UITer</Text>
          </View>
          <View level={25}>
        ...
        <View style={[styles.slide, { backgroundColor: '#009688' }]}>
          ...
          <View level={15}>
            <Text style={styles.text}>Thông tin nhanh chóng</Text>
          </View>
          <View level={25}>
            <Text style={[styles.text, { fontSize: 20, paddingTop: 10 }]}>
              Không lo bỏ lỡ các tin tức, thông báo nghỉ bù, deadline, lịch học,...
            </Text>
          </View>
        </View>
        <View style={[styles.slide, { backgroundColor: '#006064' }]}>
          ...
          <View level={15}>
            <Text style={styles.text}>Dễ dàng sử dụng</Text>
          </View>
          <View level={25}>
            <Text style={[styles.text, { fontSize: 20, paddingTop: 10 }]}>
              Giao diện thân thiện, dễ dàng kéo thả để cập nhật thông tin
            </Text>
          </View>
        </View>
        <View style={[styles.slide, { backgroundColor: '#F57F17' }]}>
          ...
          <View level={15}>
            <Text style={styles.text}>Bắt đầu thôi nào!</Text>
          </View>
          <View level={25}>
            <Text style={[styles.text, { fontSize: 20, paddingTop: 10 }]}>
              Chỉ cần nhập tài khoản chứng thực và bạn đã có thể sử dụng
            </Text>
          </View>
        </View>
      </AppIntro>
